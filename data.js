...
export const POIS = [
  ...
  },
  {
    ...
    emoji: '🌅',
    descripcion:
      'Una grabación del espectacular atardecer sobre el horizonte marino. Una imagen que nos transmite paz, con los últimos rayos de sol tiñendo el mar de tonos naranja y dorado en un momento de relajación absoluta.',
    lat: 39.8875,
    lng: 4.2500,
...
export function updatePoi(id, datos) {
  const idx = POIS.findIndex(p => p.id === id);
  if (idx !== -1) Object.assign(POIS[idx], datos);
}
